...
$().ready(function () {
    ...
    if (loggedUser == null) {
        ...
        if (loggedUser.type == "company") {
            ...
            const all_my_parks = parkService.getAllParksByUserId(loggedUser.id ?? -1);
        ...
        const all_parks = parkService.getAllParks();
        ...
        const my_cars = carService.getAllCarsByUserId(loggedUser.id ?? -1);
        ...
        for (const car of my_cars) {
            ...
            cars_list.prepend(a);
            if (car.has_reserv) {
                var res = reservationService.getAllReservationsByCarId(car.id ?? -1);
